...
`timescale 1 ns / 1 ps
module PLL2 (CLKI, CLKOP, CLKOS, CLKOS2, CLKOS3, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO3(), .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS3="240.000000" */
             /* synthesis FREQUENCY_PIN_CLKOS2="240.000000" */
             /* synthesis FREQUENCY_PIN_CLKOS="240.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS3 240.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 240.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 240.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 240.000000
