...
/* Module Version: 5.7 */
/* /usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n PLL1 -lang verilog -synth lse -arch xo2c00 -type pll -fin 20 -fclkop 400 -fclkop_tol 0.0 -fclkos 266 -fclkos_tol 1.0 -fclkos2 266 -fclkos2_tol 1.0 -fclkos3 114 -fclkos3_tol 1.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 0 -phases3 0 -phase_cntl STATIC -fb_mode 1 -lock -sticky  */
/* Wed Jun 24 13:26:44 2020 */


`timescale 1 ns / 1 ps
module PLL1 (CLKI, CLKOP, CLKOS, CLKOS2, CLKOS3, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO3(), .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS3="114.285714" */
             /* synthesis FREQUENCY_PIN_CLKOS2="266.666667" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS3 114.285714
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 266.666667
